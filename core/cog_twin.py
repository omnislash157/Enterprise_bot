...
# Core cognitive components - cog_twin.py cannot import from protocols (circular dependency)
# Import directly from memory modules
...
if cfg('voice.engine', 'venom') == 'enterprise':
    ...
    from .venom_voice import VenomVoice as VoiceEngine
...
class CogTwin:
    ...
    def __init__(
        ...
        self.voice = VoiceEngine(memory_count=self.memory_count)
