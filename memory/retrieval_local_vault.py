# Updated retrieval methods to use LocalVaultService
    ...
    **NEW VERSION 3.0: LOCAL-FIRST**
    ...
    if schema_data and nodes:
        try:
            ...
            cluster_schema.profiles = {int(k): ClusterProfile(**v) for k, v in schema_data.get("profiles", {}).items()}
