...
from core.schemas import MemoryNode

# Import real PostgresBackend from backends subpackage
try:
    from memory.backends.postgres import PostgresBackend as AsyncPostgresBackend
