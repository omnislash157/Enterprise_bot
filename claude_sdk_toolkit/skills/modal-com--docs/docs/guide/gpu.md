...
All H100 GPUs on the Modal platform are of the SXM variant, as can be verified by examining the [power draw](/docs/guide/gpu-metrics) in the dashboard or with `nvidia-smi`.
...
An H200’s [HBM3e memory](/gpu-glossary/device-hardware/gpu-ram) has a capacity of 141 GB and a bandwidth of 4.8TB/s, 1.75x larger and 1.4x faster than an NVIDIA H100 with HBM3.
...
[GPU acceleration](#gpu-acceleration)[Quickstart](#quickstart)[Specifying GPU type](#specifying-gpu-type)[Specifying GPU count](#specifying-gpu-count)[Picking a GPU](#picking-a-gpu)[B200 GPUs](#b200-gpus)[H200 and H100 GPUs](#h200-and-h100-gpus)[Automatic upgrades to H200s](#automatic-upgrades-to-h200s)[A100 GPUs](#a100-gpus)[GPU fallbacks](#gpu-fallbacks)[Multi GPU training](#multi-gpu-training)[Examples and more resources](#examples-and-more-resources)

Learn more

[High-speed inference with vLLM](/docs/examples/llm_inference)
