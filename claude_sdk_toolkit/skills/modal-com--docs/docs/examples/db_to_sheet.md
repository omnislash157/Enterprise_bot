---
title: Write to Google Sheets from Postgres
url: https://modal.com/docs/examples/db_to_sheet
type: examples
---
...
This entire app can now be deployed using `modal deploy db_to_sheet.py`. The [apps page](https://modal.com/apps) shows our cron job’s execution history and lets you navigate to each invocation’s logs.
