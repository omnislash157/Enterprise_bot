...
url: https://modal.com/docs/examples/basic_web
type: examples
---
...
This tutorial shows the path with the shortest [“time to 200”](https://shkspr.mobi/blog/2021/05/whats-your-apis-time-to-200/): [`modal.fastapi_endpoint`](https://modal.com/docs/reference/modal.fastapi_endpoint).
...
For more details, see the [guide to proxy authentication](https://modal.com/docs/guide/webhook-proxy-auth).
...
[Hello world wide web!](#hello-world-wide-web)[Send data to a web endpoint](#send-data-to-a-web-endpoint)[Sending data in query parameters](#sending-data-in-query-parameters)[Sending data in the request body](#sending-data-in-the-request-body)[Protect web endpoints with proxy authentication](#protect-web-endpoints-with-proxy-authentication)[What next?](#what-next)
