---
title: Analyze NYC yellow taxi data with DuckDB on Parquet files from S3
...
[Analyze NYC yellow taxi data with DuckDB on Parquet files from S3](#analyze-nyc-yellow-taxi-data-with-duckdb-on-parquet-files-from-s3)[Basic setup](#basic-setup)[Analyze data with DuckDB](#analyze-data-with-duckdb)[Plot daily taxi rides](#plot-daily-taxi-rides)[Run everything](#run-everything)
