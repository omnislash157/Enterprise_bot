...
url: https://modal.com/docs/examples/image_to_image
type: examples
---
...
[Edit images with Flux Kontext](#edit-images-with-flux-kontext)[Define a container image](#define-a-container-image)[Cache the model weights](#cache-the-model-weights)[Set up and run Flux Kontext](#set-up-and-run-flux-kontext)[Running the model from the command line](#running-the-model-from-the-command-line)
