---
title: Fine
url: https://modal.com/docs/examples/diffusers_lora_finetune
type: examples
---
...
to building on large pretrained models using Modal’s building blocks, like [GPU-accelerated](https://modal.com/docs/guide/gpu) Modal Functions and Clses for compute-intensive work, [Volumes](https://modal.com/docs/guide/volumes) for storage,
...
and then load them back in for inference. For more on storing model weights on Modal, see [this guide](https://modal.com/docs/guide/model-weights).
