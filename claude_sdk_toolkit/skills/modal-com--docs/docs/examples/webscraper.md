...
url: https://modal.com/docs/examples/webscraper
type: examples
---
...
We can pass [custom container images](/docs/guide/images) (defined using [`modal.Image`](/docs/reference/modal.Image)) to the `@app.function()` decorator. We’ll make use of the `modal.Image.debian_slim` pre-bundled Image add
...
[A simple web scraper](#a-simple-web-scraper)[Scrape links locally](#scrape-links-locally)[Add dependencies](#add-dependencies)[Scale out](#scale-out)[Deploy it and run it on a schedule](#deploy-it-and-run-it-on-a-schedule)[Add Secrets and integrate with other systems](#add-secrets-and-integrate-with-other-systems)[Summary](#summary)
