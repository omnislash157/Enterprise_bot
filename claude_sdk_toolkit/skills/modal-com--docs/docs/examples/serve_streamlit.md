---
title: Run and share Streamlit apps
url: https://modal.com/docs/examples/serve_streamlit
type: examples
---
...
[Define container dependencies](#define-container-dependencies)[Spawning the Streamlit server](#spawning-the-streamlit-server)[Iterate and Deploy](#iterate-and-deploy)
