---
title: Run Anthropic’s computer use demo in a Modal Sandbox
url: https://modal.com/docs/examples/anthropic_computer_use
type: examples
---
...
This example demonstrates how to run Anthropic’s [Computer Use demo](https://github.com/anthropics/anthropic-quickstarts/tree/main/computer-use-demo) in a Modal [Sandbox](https://modal.com/docs/guide/sandbox).
...
We’ll provide the Anthropic API key via a Modal [Secret](https://modal.com/docs/guide/secrets) which the sandbox can access at runtime.
