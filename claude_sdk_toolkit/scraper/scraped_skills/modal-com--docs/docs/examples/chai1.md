---
title: Fold proteins with Chai
url: https://modal.com/docs/examples/chai1
type: examples
---

# Fold proteins with Chai
...
[Fold proteins with Chai-1](#fold-proteins-with-chai-1)[Setup](#setup)[Fold a protein from the command line](#fold-a-protein-from-the-command-line)[Addenda](#addenda)
