---
title: Create a Chatterbox TTS API on Modal
url: https://modal.com/docs/examples/chatterbox_tts
type: examples
---
...
[View on GitHub](https://github.com/modal-labs/modal-examples/blob/main/06_gpu_and_ml/text-to-audio/chatterbox_tts.py)
...
[Setup](#setup)[Define a container image](#define-a-container-image)[The TTS model class](#the-tts-model-class)
...
```shiki
modal run 06_gpu_and_ml/text-to-audio/chatterbox_tts.py
```
